...
\begin{figure}[!tbp]%
  ...
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim = 1.2cm 0cm 0.4cm 0cm, clip=true]{./figure02a.pdf}%
    \caption{$x=0\,\unit{m}$.}%
  \end{subfigure}\hfill%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim = 1.2cm 0cm 0.4cm 0cm, clip=true]{./figure02b.pdf}%
    \caption{$z=0.0525\,\unit{m}$ (center height of $\mathcal{V}_{1}$).}%
  \end{subfigure}\\%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim = 1.2cm 0cm 0.4cm 0cm, clip=true]{./figure02c.pdf}%
    \caption{$z=0.0775\,\unit{m}$ (center height of $\mathcal{V}_{3}$).}%
 \end{subfigure}\hfill%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim = 1.2cm 0cm 0.4cm 0cm, clip=true]{./figure02d.pdf}%
    \caption{$z=0.1025\,\unit{m}$ (center height of $\mathcal{V}_{5}$).}%
  \end{subfigure}\\%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim = 1.2cm 0cm 0.4cm 0cm, clip=true]{./figure02e.pdf}%
    \caption{$z=0.1275\,\unit{m}$ (center height of $\mathcal{V}_{7}$).}%
  \end{subfigure}\hfill%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim = 1.2cm 0cm 0.4cm 0cm, clip=true]{./figure02f.pdf}%
...
\begin{figure}[!tbp]%
  \centering%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.4cm 0cm 1.4cm 0cm, clip=true]{./figure03a.pdf}%
    \caption{$\wt{Z}$.}%
  \end{subfigure}\hfill%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.4cm 0cm 1.4cm 0cm, clip=true]{./figure03b.pdf}%
    \caption{$\wt{Z''}$.}%
  \end{subfigure}\\%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.4cm 0cm 1.4cm 0cm, clip=true]{./figure03c.pdf}%
    \caption{$\wt{c}$.}%
 \end{subfigure}\hfill%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.4cm 0cm 1.4cm 0cm, clip=true]{./figure03d.pdf}%
    \caption{$\wt{c''}$.}%
  \end{subfigure}
  % \\%
  % \begin{subfigure}[t]{0.48\textwidth}%
  %   \includegraphics[page=5,width=\textwidth]{./dice_0004_slice.pdf}%
...
\begin{figure}[!tbp]%
  \centering%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.5cm 0cm 1.5cm 1.1cm, clip=true]{./figure04a.pdf}%
    \caption{Marginal $P(Z,c)$ as a function of $Z$.}%
  \end{subfigure}\hfill%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.5cm 0cm 1.5cm 1.1cm, clip=true]{./figure04b.pdf}%
    \caption{Marginal $P(Z,c)$ as a function of $c$.}%
  \end{subfigure}\\%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.5cm 0cm 1.5cm 1.1cm, clip=true]{./figure04c.pdf}%
    \caption{Marginal conditional means of $\dot{\omega}$ as a function of $Z$.}%
  \end{subfigure}\hfill%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.5cm 0cm 1.5cm 1.1cm, clip=true]{./figure04d.pdf}%
...
\begin{figure}[!tbp]%
  \centering%
  \includegraphics[page=1, height=0.49\textwidth, trim=0.0cm 0cm 0.cm 0cm, clip]{./figure05.pdf}%
...
\begin{figure}[!tbp]%
  \centering%
  \includegraphics[width=0.9\textwidth]{./figure06.pdf}\\%
...
\begin{figure}[!tbp]%
  ...
  \begin{subfigure}[t]{0.48\textwidth}%
    \centering
    \includegraphics[width=0.85\textwidth]{./figure07a.pdf}%
  ...
  \begin{subfigure}[t]{0.48\textwidth}%
    \centering
    \includegraphics[width=\textwidth]{./figure07b.pdf}%
...
\begin{figure}[!tbp]%
  ...
  \begin{subfigure}[t]{\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.2cm 0cm 1.5cm 1.3cm, clip=true]{./figure08a.pdf}%
    \caption{$J(P||P_{\beta})=0$.}\label{fig:}%
  \end{subfigure}\hfill%
  \begin{subfigure}[t]{\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.2cm 0cm 1.5cm 1.3cm, clip=true]{./figure08b.pdf}%
    \caption{$J(P||P_{\beta})=\nicefrac{\ln{(2)}}{2}$.}\label{fig:pdfs_hilo_2}%
  \end{subfigure}\hfill%
  \begin{subfigure}[t]{\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.2cm 0cm 1.5cm 1.3cm, clip=true]{./figure08c.pdf}%
...
\begin{figure}[!tbp]%
  \centering%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.5cm 0cm 1.5cm 1.3cm, clip=true]{./figure09a.pdf}%
    \caption{\Gls{fdf} of $J$.}\label{fig:jsd_pdf}%
  \end{subfigure}\hfill%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.5cm 0cm 1.5cm 1.3cm, clip=true]{./figure09b.pdf}%
...
\begin{figure}[!tbp]%
  \centering%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.5cm 0cm 1.5cm 1.3cm, clip=true]{./figure10a.pdf}%
    \caption{$\wt{\dot{\omega}}$ predictions.}\label{fig:convolution_scatter}%
  \end{subfigure}\hfill%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.5cm 0cm 1.5cm 1.3cm, clip=true]{./figure10b.pdf}%
...
\begin{figure}[!tbp]%
  \centering%
  \includegraphics[page=1,width=0.6\textwidth]{./figure11.pdf}\\%
...
\begin{figure}[!tbp]%
  \centering%
  \begin{subfigure}[t]{\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.2cm 0cm 1cm 1cm, clip=true]{./figure12a.pdf}%
    \caption{$\mathcal{D}_3^t$ ($z_3=0.0775\,\unit{m}$).}\label{fig:gen_3}%
  \end{subfigure}\hfill%
  \begin{subfigure}[t]{\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.2cm 0cm 1cm 1cm, clip=true]{./figure12b.pdf}%
    \caption{$\mathcal{D}_5^t$ ($z_5=0.1025\,\unit{m}$).}\label{fig:gen_5}%
  \end{subfigure}\hfill%
  \begin{subfigure}[t]{\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.2cm 0cm 1cm 1cm, clip=true]{./figure12c.pdf}%
...
\begin{figure}[!tbp]%
  \centering%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.5cm 0cm 1.3cm 1.3cm, clip=true]{./figure13a.pdf}%
    \caption{$\wt{\dot{\omega}}$ predictions.}%
  \end{subfigure}\hfill%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.5cm 0cm 1.5cm 1.3cm, clip=true]{./figure13b.pdf}%
    \caption{\mbox{Conditional means of $\wt{\dot{\omega}}$ as a function of $\wt{z}$.}}%
  \end{subfigure}\\[0.2cm]%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.5cm 0cm 1.5cm 1.3cm, clip=true]{./figure13c.pdf}%
...
\begin{figure}[!tbp]%
  \centering%
  \begin{subfigure}[t]{\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.2cm 0cm 1cm 1cm, clip=true]{./figure14a.pdf}%
    \caption{$J(P||P_{\text{\gls{dnn}}})=0.05$.}\label{fig:}%
  \end{subfigure}\hfill%
  \begin{subfigure}[t]{\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.2cm 0cm 1cm 1cm, clip=true]{./figure14b.pdf}%
    \caption{$J(P||P_{\text{\gls{dnn}}})=0.1$.}\label{fig:}%
  \end{subfigure}\hfill%
  \begin{subfigure}[t]{\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.2cm 0cm 1cm 1cm, clip=true]{./figure14c.pdf}%
...
\begin{figure}[!tbp]%
  \centering%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.5cm 0cm 1.3cm 1.3cm, clip=true]{./figure15a.pdf}%
    \caption{$J_{90}$.}%
  \end{subfigure}\hfill%
  \begin{subfigure}[t]{0.48\textwidth}%
    \includegraphics[page=1,width=\textwidth, trim=0.5cm 0cm 1.5cm 1.3cm, clip=true]{./figure15b.pdf}%
